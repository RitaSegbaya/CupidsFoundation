...
<head>
    ...
    <meta name="Rita Segbaya" content="">
    <title>Cupids Foundation</title>
...
<body>
        ...
        <div class="container">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="assets/images/logo.png" alt="Logo" width=35%>
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="training.php">Services</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="page-scroll" href="login/signup.php" data-target="signup">Signup</a>
                        </li>
                        <li>
                ...
                <div id="owl-demo" class="owl-carousel header1">
                    <div>
                        <div class="col-xs-12 col-sm-6 col-md-6 header-text">
                            <h2 class="wow bounceIn animated" data-wow-delay=".40s">BE A <span>PARTNER</span> AND <br/>GIVE ANOTHER HOPE</h2>
                            <h3 class="wow bounceIn animated" data-wow-delay=".50s">FOR THE FUTURE! </h3>

                            <p>
                                <div class="btn btn-primary btn-lg btn-ornge wow bounceIn animated" data-wow-delay="1s"><i class="hbtn"></i> <span><a href="#contact">Reach out to us</a></span></i>
                                </div>
                            </p>
                        </div>
                    </div>
                    <div>
                        <div class="col-xs-12 col-sm-6 col-md-6 header-text">
                            <h2 class="wow bounceIn animated" data-wow-delay=".40s">JOIN A <span>PROGRAM</span> AND <br/>LEARN A SKILL</h2>
                            <h3 class="wow bounceIn animated" data-wow-delay=".50s">FOR YOUR DEVELOPMENT </h3>
                            <p class="wow bounceIn animated" data-wow-delay=".60s">Learn a skill, join a project and become a better YOU!</p>
                            <p>
                                <div class="btn btn-primary btn-lg btn-ornge wow bounceIn animated" data-wow-delay="1s"><i class="hbtn"></i> <span><a href="login/signup.php">Signup Here</a></span></i>
                                </div>
                            </p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInDown animated" data-wow-delay=".5s">
                    ...
                    <article class="concept">
                        ...
                        <p>
                            Cupids Foundation is a social eneterprise with income earning activities. <br> With the rising and alarming rate of sexual abuse and lack of consent culture, we seek to provide vocational training skills for teenage mothers.
                            <br> These teenage mothers do not necessarily have to be rape victims. We are basically looking for ways to help them cater for their needs and that of their children.
                        </p>
                        <p>
                            On this website, we provide teenage mothers with learning opportunities, project participation and links to jobs. <br> With our projects, we carry out various activities including consent culture sensitization and providing
                            help and shelter to rape victims.
                            <br>
                            <br>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInDown animated" data-wow-delay=".1s">
                    <div class="timg"><img src="assets/images/riri.jpg" /></div>
                    <div class="t-box">
                        <h3>Rita Segbaya</h3>
                        <span>Team Lead </span>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInUp animated" data-wow-delay=".2s">
                    <div class="timg"><img src="assets/images/team.jpg" /></div>
                    <div class="t-box">
                        <h3>The Team</h3>
                        <span>Cupids Team</span>
                        <ul class="social-links">
                            <li><a class="wow fadeInUp animated" href="index.html#"><i class="fa fa-facebook"></i></a></li>
                            <li><a data-wow-delay=".1s" class="wow fadeInUp animated" href="index.html#"><i class="fa fa-twitter"></i></a></li>
                            <li><a data-wow-delay=".2s" class="wow fadeInUp animated" href="index.html#"><i class="fa fa-google-plus"></i></a></li>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3 wow rotateInDownLeft animated" data-wow-delay=".1s">
                    ...
                    <div class="wbox">
                        ...
                        <a href="../Cupidstry/training.php" class="clr1-a">+</a>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 wow rotateInDownLeft animated" data-wow-delay=".2s">
                    ...
                    <div class="wbox">
                        ...
                        <a href="../Cupidstry/training.php" class="clr2-a">+</a>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 wow rotateInDownRight animated" data-wow-delay=".3s">
                    ...
                    <div class="wbox">
                        <a href="admin/login.php" class="clr3-a">+</a>
                    </div>
    ...
    <section id="Gallery" class="wow flipInX animated" data-wow-delay=".5s">
        <div class="title">
            <h2>Gallery</h2>
            <p>Look through some pictures from our project launch</p>
        </div>
        ...
        <div class="big-demo go-wide" data-js-module="filtering-demo">
            ...
            <div class="grid baguetteBoxThree gallery">
                <div class="element-item transition webdesign " data-category="post-transition">
                    <a href="assets/images/launch1.jpg">
                        <img src="assets/images/launch1.jpg" />
                        <div class="hover-img">
                ...
                <div class="element-item post-transition ecommerce " data-category="post-transition">
                    <a href="assets/images/launch2.jpg">
                        <img src="assets/images/launch2.jpg" />
                        <div class="hover-img">
                            <i class="fa fa-camera camera"></i>
                        </div>
                    </a>
                ...
                <div class="element-item post-transition ecommerce " data-category="post-transition">
                    <a href="assets/images/launch3.jpg">
                        <img src="assets/images/launch3.jpg" />
                        <div class="hover-img">
                            <i class="fa fa-camera camera"></i>
                        </div>
                    </a>
                ...
                <div class="element-item post-transition ecommerce " data-category="post-transition">
                    <a href="assets/images/launch4.jpg">
                        <img src="assets/images/launch4.jpg" />
                        <div class="hover-img">
                            <i class="fa fa-camera camera"></i>
                        </div>
                    </a>
                ...
                <div class="element-item post-transition ecommerce " data-category="post-transition">
                    <a href="assets/images/backdrop.jpg">
                        <img src="assets/images/backdrop.jpg" />
                        <div class="hover-img">
                            <i class="fa fa-camera camera"></i>
                        </div>
                    </a>
                ...
                <div class="element-item post-transition ecommerce " data-category="post-transition">
                    <a href="assets/images/launch6.jpg">
                        <img src="assets/images/launch6.jpg" />
                        <div class="hover-img">
                            <i class="fa fa-camera camera"></i>
                        </div>
                    </a>
                ...
                <div class="element-item post-transition ecommerce " data-category="post-transition">
                    <a href="assets/images/launch7.jpg">
                        <img src="assets/images/launch7.jpg" />
                        <div class="hover-img">
                            <i class="fa fa-camera camera"></i>
                        </div>
                    </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    ...
                    <p class="copyright">
                        &copy; 2021 cupidsfoundation. Created By <a href="http://templatestock.co">Template Stock</a> edited for cupidsfoundation <br>
                ...
                <div data-wow-delay=".6s" class="col-xs-12 col-sm-6 col-md-6 wow bounceIn  animated" style="visibility: visible; animation-delay: 0.6s; animation-name: bounceIn;">
                    ...
                    <section class="widget widget_text" id="text-15">
                        <h3 class="widget-title">Cupids Foundation</h3>
                        <div class="textwidget">1 University Avenue, Berekusu<br>
                            <p>Tel: 00233-20-5825-225<br> Mobile: 00233-2058-252-525<br> E-mail: <a href="#">info@cupidsfoundation.com</a></p>
                            Get directions on the map →</div>
                    </section>
